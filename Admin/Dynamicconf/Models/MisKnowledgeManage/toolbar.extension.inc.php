...
return array(
		...
		'js-add' => array(
				'ifcheck' => '1',
				'permisname' => 'misknowledgemanage_add',
		...
		'js-delete' => array(
				...
				'permisname' => 'misknowledgemanage_delete',
		...
		'js-edit' => array(
				'ifcheck' => '1',
				'rules' => '#auditState#==0||#auditState#==-1',
				'permisname' => 'misknowledgemanage_edit',
				'html' => '<a class="edit js-edit tml-btn tml_look_btn tml_mp" href="__URL__/edit/id/{sid_node}" rel="__MODULE__edit" target="navTab" mask="true" title="文章_修改"><span><span class="icon icon-edit icon_lrp"></span>修改</span></a>',
				'shows' => '1',
				'sortnum' => '3',
		),
		//查看
		'js-view' => array(
			'ifcheck' => '0',
			'permisname' => 'misknowledgemanage_view',
			'html' => '<a class="js-view icon tml-btn tml_look_btn tml_mp" href="__URL__/view/id/{sid_node}" rel="__MODULE__view" target="navTab" mask="true"  title="文章_查看"><span><span class="icon icon-eye-open icon_lrp"></span>查看</span></a>',
			'shows' => '1',
			'sortnum' => '4',
		),
		//单据撤回
