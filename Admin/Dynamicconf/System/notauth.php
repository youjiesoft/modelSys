<?php
$notauth= array(
	'NOT_AUTH_MODULE'=>'Index,TimedTask,MisSystemDataRemindMas,Public,MisOaItems,MisFileManager,MisOaItemsWaitFor,MisSaleWaybillDetails,MisWorkStatement,MisSystemAnnouncement,UserInfo,UserOftenMenu,ReportCharts,CheckFor,Search,MisChat,SendMsg,MisMessage,MisMessageInbox,MisMessageOutbox,MisMessageDrafts,MisMessageRecycle,ReportExcel,OAHelper,MisMessagePhone,MisHrRemindBecomeEmployee,MisHrRemindEmployeeContract,MisUserEvents,MisSystemFunctionalBox,WXHelper,MisSystemApp,DesingForm,MisSaleProjectProgress,MisSystemSysremind',		// 默认无需认证模块
	'NOT_AUTH_ACTION'=>'miniindex,changeRoleOnlyOneEdit,ganyuEdit,showContent,getDBData,auditStartDiv,enterToSubmitAudit,nvigateTO,additemview,acquire,mybusiness,wordPlaySwf,getFormFlow,showMessage,myCoursesList,roleGroupAuthorizeC,baseInfo,detail,clear_cache,workplatform,audit,insert,update,updateControll,view,waitAudit,alreadyAudit,auditProcess,backprocess,auditEdit,startprocess,auditView,seeProcessDetail,seeAuditUser,playSWF,sureProcess,getAllScheduleList,setDbhaSmsgType,organization,misimportexceladd,misimportexcelinsert,tmlbbs,misFileManageDownload,autoPanelShow,businessCaseAnalysis,getAutoFormTabs,getAutoFormTabsForAll',	// 默认无需认证操作
	//既定方法
