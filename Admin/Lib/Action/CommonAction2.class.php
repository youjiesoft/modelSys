...
// 								$list = $lastID[0]['returnval'];
    ...
    public function  _over_insert($modelname,$id,$updateBackup){
        ...
        if ($modelname == 'MisSalesMyProject'&& $_POST['xinzeng']==1) {
            //主体内容
            $_POST['chanyelian']=empty($_POST['chanyelian'])?$_POST['cyl']:$_POST['chanyelian'];
            $_POST['yixiangdanbaofeilv']=empty($_POST['yixiangdanbaofeilv'])?0:$_POST['yixiangdanbaofeilv'];
            $_POST['zaibaojine']=empty($_POST['zaibaojine'])?0:$_POST['zaibaojine'];
            $_POST['zt']=empty($_POST['zt'])?$_POST['zhuti']:$_POST['zt'];
            $_POST['shenqingyewuqixian']=empty($_POST['shenqingyewuqixian'])?$_POST['shenqingqixian']:$_POST['shenqingqixian'];
            $_POST['xiangmubianma']=empty($_POST['xiangmubianma'])?$_POST['orderno']:$_POST['shenqingyewuqixian'];
            $_POST['xifenpinlei']=empty($_POST['xifenpinlei'])?$_POST['hy']:$_POST['xifenpinlei'];
            $_POST['dangqiankehmc']=empty($_POST['dangqiankehmc'])?$_POST['customername']:$_POST['dangqiankehmc'];
            $_POST['xiangmujieduan']=1;
            $_POST['allnode']='MisAutoPvb';
            $_POST['yewuleixing']=$_POST['typeid'];
            $_POST['createtime']=time();
            //插件内容
            $_POST['zhudiao']=$_POST['zd'];
            $_POST['fudiao']=$_POST['fd'];
            $_POST['lixiangbumen']=$_POST['zddeptid'];
            $_POST['fengxiandengji']=empty($_POST['fengxiandengji'])?$_POST['fengxiandj']:$_POST['fengxiandengji'];
            $_POST['baodaihourenyuan']=$_POST['baohouzhudiao'];
            $_POST["fengxianpingshenreny"]=$_POST['baohoujingli'];
            $_POST["projectid"]=$id;
            $data1[]=$_POST;
//				var_dump($data1);
//				exit;
            M("mis_auto_bklne")->addAll($data1);
            ...
            $re=M('mis_auto_kimpu');
            $re1=$re->where('id='.$id)->find();
            $data01['name']=$_POST['xiangmumingchen'];
            $data01['zt']=$_POST['zhuti'];
            $re2=$re->where('id='.$id)->save($data01);
            //加入数据控制
