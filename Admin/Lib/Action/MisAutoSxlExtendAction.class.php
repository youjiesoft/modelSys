 ...
 * @date 2015-04-24 13:03:32
 * @version V1.0
*/
class MisAutoSxlExtendAction extends CommonAction {
	...
	*/
	function _extend_after_insert($id){
		...
		if($vlist===false){
			logs($Vphsubmodel->getLastSql() , 'MisAutoSxl_after_insert_'.date('Y-m-d-H' , time()) ,'',__CLASS__,__FUNCTION__,__METHOD__);
