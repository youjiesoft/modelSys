 ...
 * @version V1.0
*/
class MisAutoZoqAction extends MisAutoZoqExtendAction {
	...
	*/
	function _before_insert(){
		$this->checkifexistcodeororder('mis_auto_njzcw','orderno',$this->getActionName());
	...
	*/
	function _before_update(){
		$this->checkifexistcodeororder('mis_auto_njzcw','orderno',$this->getActionName(),1);
