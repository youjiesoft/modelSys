...
EOF;
                                break;
                            case 'lookup' :
                                if($controllProperty['istwodimensional'] == 1){
                                    break;
                                }
                                $lookupParame      = '';
                                $config            = '';
...
EOF;
                ...
                $temp
                    = <<<EOF
                                                ...
                                                {$titles}
                                                <table class="into_table_new nbm_data_table {$twodimensional}" distinguish="{$orgTag}" table_data='{"formModel":"{$this->nodeName}","datatableModel":"{$dataTableModelName}","importUrl":"__APP__/MisImportExcel/misimportexceladd"}' id="{$datatableID}" table_type="{$tableoprate}">
