...
EOF;
        ...
        //$phpcode.=$before_edit.$before_insert.$before_update.$after_edit.$after_list.$after_insert.$after_add.$after_update;
        $phpcode.=$index.$edit.$before_index.$before_edit.$before_insert.$before_update.$before_delete.$after_edit.$after_insert.$before_add.$after_update.$delChildData.$after_view;
        $phpcode.="\r\n}\r\n?>";
        $extendphpcode.="\r\n}\r\n?>";
        if(!is_dir(dirname($actionPath))) mk_dir(dirname($actionPath),0777);
        if( false === file_put_contents( $actionPath , $phpcode )){
...
EOF;
    ...
    private function dataTableEditCode($v , $property){
        ...
        $after_edit  ="\r\n\t\t// Sun 判断二维表";
        $after_edit .="\r\n\t\t\$shujukumingcheng=".'"'.$this->tableName."_sub_\";";
        $after_edit .="\r\n\t\t\$this->assign(\"shujukumingcheng\",\$shujukumingcheng);";
        ...
        if($v['istwodimensional']){
            $after_edit .= "\r\n\t\t // Sun 二维表设置".$v[$property['fields']['name']];
            $after_edit .= "\r\n\t\t \$arry".$this->tableName.'_sub_'.$v[$property['fields']['name']]." = array();";
            $after_edit .= "\r\n\t\t foreach (\$innerTabelObj".$v[$property['fields']['name']]."Data as \$item){";
            $after_edit .= "\r\n\t\t \$arry".$this->tableName."_sub_".$v[$property['fields']['name']]."[] = \$item['zhibiaomingchen'];";
            $after_edit .= "\r\n\t\t }";
            $after_edit .= "\r\n\t\t \$i".$this->tableName.'_sub_'.$v[$property['fields']['name']]." = 0;";
            $after_edit .= "\r\n\t\t \$yum".$this->tableName.'_sub_'.$v[$property['fields']['name']] ."= array();";
            $after_edit .= "\r\n\t\t \$yum".$this->tableName.'_sub_'.$v[$property['fields']['name']]."1 = array_unique(\$arry".$this->tableName.'_sub_'.$v[$property['fields']['name']].");";
            $after_edit .= "\r\n\t\t foreach (\$yum".$this->tableName.'_sub_'.$v[$property['fields']['name']]."1 as \$item){";
            $after_edit .= "\r\n\t\t foreach (\$innerTabelObj".$v[$property['fields']['name']]."Data as \$items){";
            $after_edit .= "\r\n\t\t if (\$item == \$items['zhibiaomingchen']){";
            $after_edit .= "\r\n\t\t \$yum".$this->tableName.'_sub_'.$v[$property['fields']['name']]."[\$i".$this->tableName.'_sub_'.$v[$property['fields']['name']]."]['code']= \$items['zhibiaobianma'];";
            $after_edit .= "\r\n\t\t \$yum".$this->tableName.'_sub_'.$v[$property['fields']['name']]."[\$i".$this->tableName.'_sub_'.$v[$property['fields']['name']]."]['name']= \$items['zhibiaomingchen'];";
            $after_edit .= "\r\n\t\t break;";
            $after_edit .= "\r\n\t\t }";
            $after_edit .= "\r\n\t\t }";
            $after_edit .= "\r\n\t\t \$i".$this->tableName.'_sub_'.$v[$property['fields']['name']]."++;";
            $after_edit .= "\r\n\t\t }";
            $after_edit .= "\r\n\t\t \$this->assign(\"yum".$this->tableName.'_sub_'.$v[$property['fields']['name']]."\",\$yum".$this->tableName.'_sub_'.$v[$property['fields']['name']].");";
            $after_edit .= "\r\n\t\t \$rowcontens".$this->tableName.'_sub_'.$v[$property['fields']['name']]." = array();";
            $after_edit .= "\r\n\t\t foreach (\$innerTabelObj".$v[$property['fields']['name']]."Data as \$items=>\$val){";
            $after_edit .= "\r\n\t\t \$rowcontens".$this->tableName.'_sub_'.$v[$property['fields']['name']]."[\$val['rowcontens']-1][] = \$val;";
            $after_edit .= "\r\n\t\t }";
            $after_edit .= "\r\n\t\t \$this->assign(\"rowcontens".$this->tableName.'_sub_'.$v[$property['fields']['name']]."\",\$rowcontens".$this->tableName.'_sub_'.$v[$property['fields']['name']].");";
        }
