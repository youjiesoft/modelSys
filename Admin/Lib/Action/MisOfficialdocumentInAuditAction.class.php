 ...
 * @version V1.0
 */
class MisOfficialdocumentInAuditAction extends CommonAuditAction {
	...
	public function _before_auditEdit(){
		//查询附件信息
		$this->getAttachedRecordList($_GET['id'],true,true,'MisOfficialdocumentIn');
	}
	...
	public function getAuditTree(){
		...
		//定义rel
		$rel = "MisOfficialdocumentInAuditindex";
		//当前控制器
		$name = $this->getActionName();
		$masmodel = D($name);
		//第一部分、核稿中
	...
	public function lookupmanage(){
		...
		$param['rel']="documentinAudit_right";
