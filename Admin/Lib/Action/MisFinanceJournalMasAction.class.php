<?php
/**
 * @Title: MisFinanceJournalMasAction.class.php
 * @Package 财务模块-日记账：功能类
 * @Description: TODO(现金/银行日记账的处理)
 * @author wangcheng
 * @company 重庆特米洛科技有限公司˾
 ...
 * @version V1.0
*/
class MisFinanceJournalMasAction extends CommonAction {
	/** @Title: _filter
	 * @Description: (构造检索条件) 
	 * @author  
