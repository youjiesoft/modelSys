...
//				'3'=>array('id'=>114,'name'=>'已发办结','jumptemp'=>1,'num'=>'','md'=>'MisWorkMonitoring','worktype'=>4)
	...
	public function index() {
        if($_REQUEST['jump']==6){
            unset($_REQUEST);
            $_REQUEST=array("jump"=> "6", "md"=> "MisWorkMonitoring" ,"worktype"=>  "1", "rel"=>" ", "tablename"=> "MisAutoIbf" ,"typeid"=>"5","dsp"=> "1",
                "_URL_"=> array( 0=>"MisWorkExecuting", 1=> "index" ,2=>  "", 3=>"jump" ,4=>  "md" ,5=>  "MisWorkMonitoring" ,6=> "worktype" ,7=> "1", 8=> "rel" ,9=> "MisWorkExecutingbox",
                    10=>  "tablename" ,11=> "MisAutoIbf", 12=> "typeid", 13=> "5" ,14=> "dsp" ,15=> "1") );
        }		//第一步、组合左侧的结构
		$this->getNewLeftTree();
		//从系统待处理点击过来的
