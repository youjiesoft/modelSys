...
class MisHrPersonnelUserDeptViewModel extends ViewModel{
	public $viewFields = array(
			...
			"user"=>array('_as'=>'user','shangji','anquandengji','id'=>'userid','account','name'=>'username','last_login_time','login_count','status'=>'ustatus','_on'=>'user.employeid=mis_hr_personnel_person_info.id','_type'=>'LEFT'),
