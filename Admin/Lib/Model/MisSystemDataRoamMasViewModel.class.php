...
class MisSystemDataRoamMasViewModel extends ViewModel{
	...
	public $viewFields = array(
			...
			'mis_system_data_roam_relation_rules'=>array('_as'=>'mis_system_data_roam_relation_rules','id'=>'subid','targettype','sourcetype','rules','_on'=>'mis_system_data_roam_mas.id=mis_system_data_roam_relation_rules.masid'),
	);
}
?>