            ...
            if($data[0]){
                foreach($data[0] as $key=>$val){
                    ...
                    if ($val['isdow'] == 1) {
                        ...
                        $html.='	<a href="javascript:void(0);" target="_blank">'.$val['filename'].'</a>';
                    }
                    ...
                    if($val['online']){
                        ...
                        if(in_array($file_extension_lower,$jpgArr)){
                            if ($val['isdow'] == '1') {
                                ...
                                <a id="showimg'.$val['id'].'" download="'.$val['lookname'].'" style="display:none" data-gallery="" title="'.$val['lookname'].'" href="'.$file_path.'">
                                <span class="icon icon-file"></span> 在线查看
                                </a>';
                            }else {
                                $html.='<a id="showimg'.$val['id'].'" download="'.$val['lookname'].'" class="tml-btn tml-btn-small tml-btn-green tml-ml5" style="cursor:pointer;" data-gallery="" title="'.$val['lookname'].'" href="javascript:void(0);">
                                <span class="icon icon-file"></span> 在线查看</a>
                                <a id="showimg'.$val['id'].'" download="'.$val['lookname'].'" style="display:none" data-gallery="" title="'.$val['lookname'].'" href="'.$file_path.'">
                                <span class="icon icon-file"></span> 在线查看
                                </a>';
                            ...
                            if ($val['isdow'] == 1) {
                                ...
                                $html.='<a class="tml-btn tml-btn-small tml-btn-green tml-ml5" style="cursor:pointer;" href="javascript:void(0);"></span> 在线查看</a>';
                            }
