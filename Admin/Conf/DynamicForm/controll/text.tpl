						...
						<div class="#class#" original="#original#" category="#category#" style="#style#">
							...
							<input  dropback="#dropback#" #paramArr# type="text"  name="#fields#" #callback# class=" input_new  #content_class#" <if condition="$vo['#fields#'] neq ''">value="{$vo['#fields#']}"<else/>value="#defaultvaltext#"</if>  >
