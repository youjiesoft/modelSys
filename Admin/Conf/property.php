...
$NBM_DEFAULTFIELD = array (
	...
	'isVoid'=>array('type'=>'int','length'=>'10',	'default'=>'0',	'isnull'=>'NULL' , 	'desc'=>"COMMENT '是否作废按钮状态'", 'title'=>'是否作废','canuse'=>'1', 'fieldcategory'=>'default'),
    'supcategory'  =>array('type'=>'int','length'=>'10',	'default'=>'0',	'isnull'=>'NULL' , 	'desc'=>"COMMENT '业务类型'", 'title'=>'业务类型','canuse'=>'1', 'fieldcategory'=>'default'),
    'category'     =>array('type'=>'int','length'=>'10',	'default'=>'0',	'isnull'=>'NULL' , 	'desc'=>"COMMENT '任务类型'", 'title'=>'任务类型','canuse'=>'1', 'fieldcategory'=>'default'),
...
//系统预定义字段
$SYSTEM_FIELD=array("isVoid"=>'是否作废',"supcategory"=>'业务类型',"category"=>'任务类型',"departmentid"=>'部门id', "sysdutyid"=>"职级id", "projectid"=>"项目id", "projectworkid"=>"任务id","companyid"=>"公司id","createid"=>"创建人id");
