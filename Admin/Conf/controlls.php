...
// 				),
				...
				'dbfield'=>'valedit',
				'isforeignoprate' => 1,
				'dialogcontroll'=>'valeditcontroll',
				'dialogtitle'=>'值更新',
				'displayright'=>1,
			)
		),
    ...
    'button'		=>	array(
        ...
        'listhight'=>'',//列表高度
        'html'	=>	'
		<div class="nbm_controll $isshow" data="button" $checkorder $isline >
		<label class="label_new"><i class="$copycontrollcls"></i> 0组件</label><input type="button" class="input_new"> $hidden
		$delTag
		</div>
		<div class="nbmshadow short-element">
	           <div class="icon_stort_lay">$statusHtml</div>
        ...
        'property' => array(
            ...
            ),'subimporttableroamobj'	=>	array(
                'title'	=>	'需要绑定的漫游',
                'type'	=>	'select',
                'id'	=>	'subimporttableroamobj',
                'name'	=>	'subimporttableroamobj',
                'data'	=>	'',
                'dataAdd'=> 'getRoams', //获取漫游信息
                'parentto' => 'subimporttableobj', //重新获取值时条件值来源对象
                'group'=>'c',
                'toggle'=>'d',
                'displayright'=>1,
                'isforeignoprate' => 1,
                'dbfield'=>'subimporttableroamobj',

            ),'subimporttablestoreobj'	=>	array(
                'title'	=>	'需要调用的存储过程名称',
                'type'	=>	'text',
                'id'	=>	'subimporttablestoreobj',
                'name'	=>	'subimporttablestoreobj',
                'data'	=>	'',
                'dataAdd'=>'',
                'parentto' => '', //重新获取值时条件值来源对象
                'displayright'=>1,
                'isforeignoprate' => 1,
                'dbfield'=>'subimporttablestoreobj',

            ),'subimporttablephpobj'	=>	array(
                'title'	=>	'调用的PHP方法名',
                'type'	=>	'text',
                'id'	=>	'subimporttablephpobj',
                'name'	=>	'subimporttablephpobj',
                'data'	=>	'',
//                'dataAdd'=>'comboxgetTableField',
                'parentto' => '', //重新获取值时条件值来源对象
                'displayright'=>1,
                'isforeignoprate' => 1,
                'dbfield'=>'subimporttablephpobj',

            ),'subimporttablejsobj'	=>	array(
                'title'	=>	'调用的JS文件名称',
                'type'	=>	'text',
                'id'	=>	'subimporttablejsobj',
                'name'	=>	'subimporttablejsobj',
                'data'	=>	'',
//                'dataAdd'=>'comboxgetTableField',
                'parentto' => '', //重新获取值时条件值来源对象
                'displayright'=>1,
                'isforeignoprate' => 1,
                'dbfield'=>'subimporttablejsobj',
		...
		,'property' => array(
			...
			'requiredfield'	=>	array( // 从检查类型中抽取出来的检查属性
			    ...
			    'function'=>'changetagsortandrequired',
					...
					'isforeignoprate' => 1,
					// select option(val|text ) # op # op
					'data'	=>	'1|无需验证#eamil|邮箱#url|网址#number|整数#double|浮点数#lettersonly|字母#idcard|身份证',
					'displayright'=>1,
			),
			'org'	=>	array(
				'title'	=>	'ORG设置',
...
//				'displayright'=>1,
//			),
			'istwodimensional'  => array( // 从检查类型中抽取出来的检查属性
                                     'title'            => '是否二维表录入',
                                     'type'             => 'checkbox',
                                     'default'          => '0',
                                     'id'               => 'istwodimensional',
                                     'name'             => 'istwodimensional',
                                     'dbfield'          => 'istwodimensional',
                                     'istwodimensional' => 1,
                                     'displayright'     => 1,
            ),
            'istwodimensionalshow'  => array( // 从检查类型中抽取出来的检查属性
                                     'title'            => '是否二维表显示',
                                     'type'             => 'checkbox',
                                     'default'          => '0',
                                     'id'               => 'istwodimensionalshow',
                                     'name'             => 'istwodimensionalshow',
                                     'dbfield'          => 'istwodimensionalshow',
                                     'istwodimensionalshow' => 1,
                                     'displayright'     => 1,
            ),
            'isaddrowimport'  => array( // 从检查类型中抽取出来的检查属性
                'title'            => '是否显示新增行和导入',
                'type'             => 'checkbox',
                'default'          => '0',
                'id'               => 'isaddrowimport',
                'name'             => 'isaddrowimport',
                'dbfield'          => 'isaddrowimport',
                'isaddrowimport' => 1,
                'displayright'     => 1,
            ),
		...
		'iframe'		=>	array(
                ...
                'listwidth'=>'',//列表宽度
                'html'	=>	'
		<div class="nbm_controll $isshow" data="iframe" $checkorder $isline >
		<label class="label_new"><i class="$copycontrollcls"></i> $title</label><iframe width="100%" height="50" src="http://www.baidu.com"></iframe> $hidden  
		$delTag
		</div>
