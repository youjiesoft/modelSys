...
// 				'toggle'=>'c,d',
    ...
    'areainfomap'	=>	array(
        ...
        'isconfig'=>	1 , // 是否生成字段配置
        'html'	=>	'
		<div class="$isshow nbm_controll" data="areainfomap" $checkorder $isline >
			<label class="label_new "><i class="$copycontrollcls"></i> 新地图组件：</label>
			<div class="address_elm left">
				<input class="address_four_level input_new left" placeholder="地址显示：省、市、区县、详细地址" type="text" disabled/>
				<a class="icon-map-marker address_icon_link left" href="#"></a>
			</div>
			$delTag $hidden 
		</div>
